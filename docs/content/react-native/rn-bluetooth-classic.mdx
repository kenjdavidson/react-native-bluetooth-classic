...
<a name="startDiscovery"></a>
<ExpansionPanel title="startDiscovery(): Promise<BluetoothDevice[]>">
...
<a name="cancelDiscovery"></a>
<ExpansionPanel title="cancelDiscovery(): Promise<boolean>">
...
<a name="pairDevice"></a>
<ExpansionPanel title="pairDevice(address: string): Promise<BluetoothDevice>">
...
<a name="unpairDevice"></a>
<ExpansionPanel title="unpairDevice(address: string): Promise<boolean>">
...
<a name="accept"></a>
<ExpansionPanel title="accept(properties: Map<string,object>): Promise<BluetoothDevice>">
...
<a name="cancelAccept"></a>
<ExpansionPanel title="cancelAccept(): Promise<boolean>">
...
<a name="requestBluetoothEnabled"></a>
<ExpansionPanel title="requestBluetoothEnabled(): Promise<boolean>">
...
<a name="setBluetoothAdapterName"></a>
<ExpansionPanel title="setBluetoothAdapterName(name: string): Promise<boolean>">
