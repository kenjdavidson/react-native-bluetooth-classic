...
<ExpansionPanel title="isConnected(): Promise<boolean>">
...
<a name="connect"></a>
<ExpansionPanel title="connect(options: Map<string,object>): Promise<boolean>">
...
<a name="disconnect"></a>
<ExpansionPanel title="disconnect(): Promise<boolean>">
...
<a name="available"></a>
<ExpansionPanel title="available(): Promise<number>">
...
<a name="clear"></a>
<ExpansionPanel title="clear(): Promise<boolean>">
...
<a name="read"></a>
<ExpansionPanel title="read(): Promise<BluetoothMessage>">
...
<a name="write"></a>
<ExpansionPanel title="write(data: string|Buffer)">
...
<a name="onDataReceived"></a>
<ExpansionPanel title="onDataReceived(listener: BluetoothEventListener<BluetoothDeviceReadEvent>): BluetoothEventSubscription">
